...
mod c_intf {
	...
	extern "C" {
		...
		pub fn crc64_append(crc: u64, input: *const c_void,
		    sz: usize) -> u64;
...
mod tests {
	...
	fn crc64_calc_test() {
		crate::crc64::init();
		assert_eq!(crate::crc64::calc("Hello World!".as_bytes()),
		    0x8afbadba3615901d);
		assert_eq!(crate::crc64::calc(
		    concat!("Lorem ipsum dolor sit amet, consectetur ",
		    ...
		    "deserunt mollit anim id est laborum.").as_bytes()),
		    0x1880b03012207bfa);
	}
	#[test]
	fn crc64_rand_test() {
