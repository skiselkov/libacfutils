...
static icao2cc_t icao2cc_table[] = {
    ...
    { .icao = "BG", .cc = "GL", .lang = "XX" },	/* Greenland */
    { .icao = "BI", .cc = "IS", .lang = "is" },	/* Iceland */
    { .icao = "BK", .cc = "XK", .lang = "XX" },	/* Kosovo */
    { .icao = "C", .cc = "CA", .lang = "en" },	/* Canada */
    { .icao = "DA", .cc = "DZ", .lang = "ar" },	/* Algeria */
    { .icao = "DB", .cc = "BJ", .lang = "XX" },	/* Benin */
    { .icao = "DF", .cc = "BF", .lang = "XX" },	/* Burkina Faso */
    { .icao = "DG", .cc = "GH", .lang = "XX" },	/* Ghana */
    { .icao = "DI", .cc = "CI", .lang = "XX" },	/* Ivory Coast */
    { .icao = "DN", .cc = "NG", .lang = "XX" },	/* Nigeria */
    { .icao = "DR", .cc = "NE", .lang = "XX" },	/* Niger */
    { .icao = "DT", .cc = "TN", .lang = "XX" },	/* Tunisia */
    ...
    { .icao = "EN", .cc = "MH", .lang = "XX" },	/* Marshall Islands */
    ...
    { .icao = "FB", .cc = "BW", .lang = "XX" },	/* Botswana */
    { .icao = "FC", .cc = "CG", .lang = "XX" },	/* Republic of the Congo */
    { .icao = "FD", .cc = "SZ", .lang = "XX" },	/* Swaziland */
    { .icao = "FE", .cc = "CF", .lang = "XX" },	/* Central African Republic */
    { .icao = "FG", .cc = "GQ", .lang = "XX" },	/* Equatorial Guinea */
    { .icao = "FH", .cc = "SH", .lang = "XX" },	/* Saint Helena Ascension */
						/* and Tristan da Cunha */
    { .icao = "FI", .cc = "MU", .lang = "XX" },	/* Mauritius */
    { .icao = "FJ", .cc = "IO", .lang = "en" },	/* British Indian Ocean */
						/* Territory */
    { .icao = "FK", .cc = "CM", .lang = "XX" },	/* Cameroon */
    { .icao = "FL", .cc = "ZM", .lang = "XX" },	/* Zambia */
    { .icao = "FMC", .cc = "KM", .lang = "XX" },	/* Comoros */
    { .icao = "FME", .cc = "RE", .lang = "XX" },	/* Réunion */
    { .icao = "FMM", .cc = "MG", .lang = "XX" },	/* Madagascar */
    { .icao = "FMN", .cc = "MG", .lang = "XX" },	/* Madagascar */
    { .icao = "FMS", .cc = "MG", .lang = "XX" },	/* Madagascar */
    ...
    { .icao = "FQ", .cc = "MZ", .lang = "XX" },	/* Mozambique */
    ...
    { .icao = "LM", .cc = "MT", .lang = "XX" },	/* Malta */
    { .icao = "LN", .cc = "MC", .lang = "fr" },	/* Monaco */
    { .icao = "LO", .cc = "AT", .lang = "de" },	/* Austria */
    { .icao = "LP", .cc = "PT", .lang = "pt" },	/* Portugal */
    { .icao = "LQ", .cc = "BA", .lang = "XX" },	/* Bosnia and Herzegovina */
    { .icao = "LR", .cc = "RO", .lang = "ro" },	/* Romania */
    { .icao = "LS", .cc = "CH", .lang = "it" },	/* Switzerland */
    { .icao = "LT", .cc = "TR", .lang = "tr" },	/* Turkey */
    { .icao = "LU", .cc = "MD", .lang = "XX" },	/* Moldova */
    { .icao = "LV", .cc = "PS", .lang = "XX" },	/* Palestine */
    { .icao = "LW", .cc = "MK", .lang = "mk" },	/* Macedonia */
    { .icao = "LX", .cc = "GI", .lang = "XX" },	/* Gibraltar */
    { .icao = "LY", .cc = "ME", .lang = "XX" },	/* Montenegro */
    { .icao = "LY", .cc = "RS", .lang = "XX" },	/* Serbia */
    { .icao = "LZ", .cc = "SK", .lang = "sk" },	/* Slovakia */
    { .icao = "MB", .cc = "TC", .lang = "XX" },	/* Turks and Caicos Islands */
    ...
    { .icao = "MT", .cc = "HT", .lang = "XX" },	/* Haiti */
    { .icao = "MU", .cc = "CU", .lang = "XX" },	/* Cuba */
    { .icao = "MW", .cc = "KY", .lang = "XX" },	/* Cayman Islands */
    { .icao = "MY", .cc = "BS", .lang = "XX" },	/* Bahamas */
    { .icao = "MZ", .cc = "BZ", .lang = "en" },	/* Belize */
    { .icao = "NC", .cc = "CK", .lang = "XX" },	/* Cook Islands */
    ...
    { .icao = "PT", .cc = "FM", .lang = "XX" },	/* Federated States of Micronesia */
    ...
    { .icao = "SF", .cc = "FK", .lang = "XX" },	/* Falkland Islands */
    ...
    { .icao = "SO", .cc = "GF", .lang = "XX" },	/* French Guiana */
    ...
    { .icao = "TL", .cc = "LC", .lang = "XX" },	/* Saint Lucia */
